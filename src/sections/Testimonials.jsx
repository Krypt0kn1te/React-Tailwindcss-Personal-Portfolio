...
const Testimonials = () => {
  ...
  return (
    <section id="testimonials" className="py-32 relative overflow-hidden">
      <div className="absolute top-1/2 left-1/2 w-[800px] h-[800px] bg-primary/5 reounded-full blur-3xl -translate-x-1/2 -translate-y-1/2" />
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        <div className="max-w-4xl mx-auto">
          <div className="relative">
            {/* Main Testimonial */}
            <div className="glass p-8 rounded-3xl md:p-12 glow-border animate-fade-in delay-200">
            ...
            <div className="flex items-center justify-center gap-4 mt-8">
              ...
              <div className="flex gap-2">
                {testimonials.map((_, idx) =>(
                  ...
                  className={`w-2 h-2 rounded-full transition-all duration-300 ${idx === activeIdx ? 'w-8 bg-primary': 'bg-muted-foreground/30 hover:bg-muted-foreground/30'}`} />
                ))}
              </div>
